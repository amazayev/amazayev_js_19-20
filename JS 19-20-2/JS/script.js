var users = [{
    ...
    "friends": [{"id": 0,"name": "Sharron Pace"}],
    "isActive": false,
  ...
  },
  {
    ...
    "friends": [{"id": 0,"name": "Briana Decker"},{"id": 1,"name": "Sharron Pace"}],
    "isActive": true,
  ...
  },
  {
    ...
    "friends": [{"id": 0,"name": "Marilyn Mcintosh"},{"id": 1,"name": "Padilla Garrison"},{"id": 2,"name": "Naomi Buckner"}],
    "isActive": false,
  ...
  },
  {
    ...
    "friends": [{"id": 0,"name": "Goldie Gentry"},{"id": 1,"name": "Aisha Tran"}],
    "isActive": true,
  ...
  },
  {
    ...
    "friends": [{"id": 0,"name": "Jordan Sampson"},{"id": 1,"name": "Eddie Strong"}],
    "isActive": true,
  ...
  },
  {
    ...
    "friends": [{"id": 0,"name": "Jacklyn Lucas"},{"id": 1,"name": "Linda Chapman"}],
    "isActive": false,
  ...
  },
{
    ...
    "friends": [{"id": 0,"name": "Goldie Gentry"},{"id": 1,"name": "Briana Decker"}],
    "isActive": true,
...
//1a. Создание массива-карты для массивов, выбирающих все значения "skills"
var resultForSkills = _.map(users, 'skills');

//1b. Создание массива уникальных значений для "skills" из отдельных массивов
var selectionUniqueData = _.union(resultForSkills[0],resultForSkills[1],resultForSkills[2],resultForSkills[3],resultForSkills[4],resultForSkills[5],resultForSkills[6]);

//1c. Сортировка результатов по имени. Имена с заглавных букв фильтруются перед именами со строчных букв.
var skillsSelector = selectionUniqueData.sort();
console.log(skillsSelector);
/////////////////////////////////////////////////////////////////////////////////1

//2a. Создание массива-карты для массивов, выбирающих все значения "friends" и "name"
var resultForNames = _.map(users, 'name');
var resultForFriends = _.map(users, 'friends');




var resultForFriends1 = _.union(resultForFriends[0])

//2b. Объединяем два объекта в один и конвертируем в массив
var zipObject = _.zipObject(resultForNames, resultForFriends1);

var array = _.toArray(zipObject);
...
//var nameByFriendsAmountSelector = _.union(sortArray[0], sortArray[1]);

console.log(resultForFriends1);


/////////////////////////////////////////////////////////////////////////////

//3a. Создание массива-карты для массивов, выбирающих все значения "friends"
var resultForFriends = _.map(users, 'friends');

//3b. Создание массива значений для поля "name" в объектах "friends"
var selectionUniqueData1 = _.union(resultForFriends[0],resultForFriends[1],resultForFriends[2],resultForFriends[3],resultForFriends[4],resultForFriends[5],resultForFriends[6]);
var resultForFriendsNames = _.map(selectionUniqueData1, 'name');

//3c. Создание массива уникальных имен для "friends"
var friendsNameSelector = _.uniq(resultForFriendsNames);
console.log(friendsNameSelector);
